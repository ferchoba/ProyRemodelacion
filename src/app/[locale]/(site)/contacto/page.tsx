    ...
    <div className="section-padding">
      <div className="container-custom">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 bg-outer-space/10 border border-quick-silver/20 rounded-lg p-8">
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="w-12 h-12 bg-outer-space rounded-full mx-auto mb-4 flex items-center justify-center">
